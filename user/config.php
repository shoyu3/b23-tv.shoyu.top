...
define( 'YOURLS_DB_USER', 'b23tv' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', 'b23tv123654' );

/** The name of the database for YOURLS */
define( 'YOURLS_DB_NAME', 'b23tv' );

/** MySQL hostname.
 ** If using a non standard port, specify it like 'hostname:port', eg. 'localhost:9999' or '127.0.0.1:666' */
define( 'YOURLS_DB_HOST', 'io3.top' );
...
define( 'YOURLS_SITE', 'http://b23-tv.shoyu.top' );
...
define( 'YOURLS_COOKIEKEY', 'ksdgusjsbbhsjsjjdbxbz' );
